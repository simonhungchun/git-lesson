...
![你的 git-practice 和「同事」的 git-practice-another](assets/15fd7796267f52f3tplv-t2oaga2asx.jpg)

现在，你就可以假装 `/git-practice` 这个目录是你的电脑上的工作目录，而那个新建的 `/git-practice-another` 是你同事的电脑上的工作目录。

![](assets/15fd779626c48d66tplv-t2oaga2asx.jpg)
...
![](assets/15fd7796252edbf5tplv-t2oaga2asx.jpg)

![嗯，「女装」](assets/15fd77962711f7d1tplv-t2oaga2asx.jpg)

嗯，看起来不错，帮他提交吧：

```shell
git add shopping\ list-colleague.txt git commit
```

![记得填写提交信息](assets/15fd7797bd664ef4tplv-t2oaga2asx.jpg)
...
![GitHub 上已经能看到刚更新的文件](assets/15fe7f81418af938tplv-t2oaga2asx.jpg)
...
![用 git pull 把代码从远程仓库取下来](assets/15fd779668e41b04tplv-t2oaga2asx.jpg)
...
![push 被拒绝](assets/1600a7635c403f2ctplv-t2oaga2asx.jpg)
...
![](assets/15fd77967acc6821tplv-t2oaga2asx.jpg)
...
![push 成功](assets/1600a786d9ac2cc5tplv-t2oaga2asx.jpg)
