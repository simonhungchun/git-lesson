在以前的学习中`checkout` 可以用来切换 `branch`：

```shell
git checkout branch2
```

![checkout](assets/160089d53b4f65a5tplv-t2oaga2asx.gif)
...
![](assets/15fe34cc387ba541tplv-t2oaga2asx.jpg)
...
![git checkout --detach](assets/1600acce7b90b009tplv-t2oaga2asx.gif)
